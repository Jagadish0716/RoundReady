...
class Settings(BaseSettings):
    ...
    service_name: str = "interviewer-service"
    environment: Environment = "development"
    log_level: str = "INFO"
    telemetry_enabled: bool = False
    database_url: str = Field(
        default="postgresql+asyncpg://roundready:roundready@localhost:5432/interviewers",
        validation_alias="INTERVIEWER_DATABASE_URL",
    )
    ...
    rabbitmq_queue: str = Field(
        default="roundready.interviewer.events", validation_alias="INTERVIEWER_EVENT_QUEUE"
    )
